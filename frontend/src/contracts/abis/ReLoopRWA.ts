export const ReLoopRWAABI = [
  ...
  {
    type: "function",
    name: "getMaxSplitForDepth",
    inputs: [{ name: "depth", type: "uint8", internalType: "uint8" }],
    outputs: [{ name: "maxSplitBps", type: "uint16", internalType: "uint16" }],
    ...
    outputs: [
      {
        name: "",
        type: "tuple[]",
        internalType: "struct ReLoopRWA.OwnerRecord[]",
        components: [
  ...
  {
    type: "function",
    name: "getPreviousOwnersForProfit",
    inputs: [{ name: "tokenId", type: "uint256", internalType: "uint256" }],
    outputs: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "profitSplitsBps", type: "uint16[]", internalType: "uint16[]" },
  ...
  },
  {
    type: "function",
    name: "setMarketplace",
    inputs: [{ name: "_marketplace", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: "oldMarketplace", type: "address", indexed: true, internalType: "address" },
      { name: "newMarketplace", type: "address", indexed: true, internalType: "address" },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "profitSplitsBps", type: "uint16[]", indexed: false, internalType: "uint16[]" },
    ],
    anonymous: false,
  },
  {
  ...
  { type: "error", name: "InvalidProfitSplits", inputs: [] },
  { type: "error", name: "MarketplaceNotSet", inputs: [] },
  { type: "error", name: "OnlyMarketplace", inputs: [] },
  {
    type: "error",
  ...
  {
    type: "error",
    name: "SplitsExceedTieredCap",
    inputs: [
      { name: "totalSplits", type: "uint256", internalType: "uint256" },
  ...
  { type: "error", name: "TotalSplitsExceedLimit", inputs: [] },
] as const;
